...
<a href="/projects/{project.id}" class="grid grid-cols-5 grid-rows-3 gap-2 p-2 cursor-pointer rounded-sm active:bg-oxford-750 hover:bg-oxford-850 hover:shadow transition-colors">
